...
// Общий каркас для всех SEO-посадочных страниц Event Wave.
...
export const SITE_URL = "https://event-wave.ru";
    ...
    <>
      ...
      <div className="ew">
        <header className="ew-hdr">
          <div className="wrap">
            <div className="inner">
              <Link href="/" className="ew-logo" aria-label="Event Wave — главная">
        ...
        <footer className="ftr">
          <div className="wrap">
            ...
            <div className="ftr-bottom">
              <span>© {new Date().getFullYear()} Event Wave — платформа диспетчеризации и логистики</span>
