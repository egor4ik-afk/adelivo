      ...
      <div style={{ marginTop: "1.2rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
          {[
            ...
            /* «Есть логисты, нет курьеров» и «Есть курьеры, нет логистов»
               убраны: человек в форме заявки не обязан раскладывать свою
               команду по нашим категориям, а промежуточные случаи всё равно
               сводились к смешанному формату. */
