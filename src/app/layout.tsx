...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og-image.png",
        // Размеры должны совпадать с файлом. Было заявлено 1200×630,
        // а лежит 1536×1024 — на таком несоответствии часть краулеров
        // отбрасывает картинку и показывает ссылку без превью.
        width: 1536,
        height: 1024,
        type: "image/png",
