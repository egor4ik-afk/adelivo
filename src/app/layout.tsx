    ...
    images: [
      {
        ...
        //
        // Файла og-image.webp в public/ не существовало вовсе — лежал только
        // og-image.webp. Telegram запрашивал ровно тот URL, что указан в
        // og:image, получал 404 и показывал карточку без картинки. VK
        // ошибку не замечал, потому что при недоступном og:image сам
        // сканирует страницу и берёт первую подходящую картинку из вёрстки.
        //
        // Теперь og-image.webp собран из png и имеет ровно 1200×630 —
        // остальные страницы объявляли этот размер, а отдавали 1536×1024.
        url: "/og-image.webp",
        width: 1200,
        height: 630,
        type: "image/jpeg",
