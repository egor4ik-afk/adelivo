...
// ВНИМАНИЕ: этот файл серверный — он реэкспортирует poll/credentials,
// а те тянут prisma и nodemailer. Из клиентских компонентов импортируйте
// справочник напрямую: import { CONNECTORS } from "@/lib/connectors/catalog"
...
export * from "./catalog";
import type { ConnectorConfig, ConnectorType, TestResult } from "./catalog";
